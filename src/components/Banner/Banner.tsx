        ...
        <div className="flex">
          ...
          <div onClick={() => Storage.setHideBanner(true)}>
                  <span className="absolute top-0 bottom-0 right-0 px-4 py-3">
                    <svg className="fill-current h-6 w-6 text-teal-500" role="button" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20">
                      <title>Close</title>
                      <path
          ...
          <div>
            ...
            <p className="text-sm">Dieses Projekt wurde im Rahmen des #WirVsVirus Hackathon
              erstellt.</p>
